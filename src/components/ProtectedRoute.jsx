 ...
 *
 * NOTE: loading stays true until BOTH the auth state AND the first
 * Firestore profile snapshot have resolved. This prevents the 1-frame
 * flash where currentUser is set but userProfile is still null.
 */
